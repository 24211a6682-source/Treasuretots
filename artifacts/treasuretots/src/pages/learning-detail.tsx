...
export default function ProductDetail() {
  ...
  const product = allBuyableProducts.find(p => p.slug === slug);
          ...
          <TabsContent value="details" className="bg-white rounded-2xl border p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-4">
              <div className="flex justify-between py-3 border-b border-dashed">
                ...
                <span className="font-medium text-right">{product.language || "English"}</span>
              </div>
              <div className="flex justify-between py-3 border-b border-dashed">
                <span className="text-muted-foreground">Age Group</span>
                <span className="font-medium text-right">{product.ageGroup || "All ages"}</span>
              </div>
              <div className="flex justify-between py-3 border-b border-dashed">
                <span className="text-muted-foreground">Format</span>
                <span className="font-medium text-right">{product.format || "Standard"}</span>
              </div>
              <div className="flex justify-between py-3 border-b border-dashed">
