...
export default function Labels() {
  const { data, isLoading, isError } = useListProducts({ category: "labels", per_page: 20 });
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center text-sm text-muted-foreground mb-4">
          ...
          <span className="text-foreground font-medium">Name Tags</span>
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">Name Tags</h1>
