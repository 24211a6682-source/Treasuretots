...
// Learning & Devotion products (BUY DIRECTLY)
export const learningProducts: ProductData[] = [
  {
    id: 1,
    ...
    description: "A beautifully illustrated Hanuman Chalisa book in English. Perfect for children to learn devotional shlokas with colorful, engaging artwork. Handcrafted with love by TreasureTots Creations.",
    language: "English",
    ageGroup: "3–10 years",
    format: "Paperback",
  },
  {
    ...
    price: 120,
    isBuyable: true,
    coverImage: "/assets/images/hanuman-telugu/hanuman4.jpg",
    images: [
      "/assets/images/hanuman-telugu/hanuman4.jpg",
      "/assets/images/hanuman-telugu/hanuman5.jpg",
      "/assets/images/hanuman-telugu/hanuman6.jpg",
    ],
    description: "A beautifully illustrated Hanuman Chalisa book in Telugu. Perfect for children to learn devotional shlokas with colorful, engaging artwork. Handcrafted with love by TreasureTots Creations.",
    language: "Telugu",
    ageGroup: "3–10 years",
    format: "Paperback",
  },
  ...
  },
  {
    ...
    description: "The divine wedding of Lord Srinivasa beautifully narrated for children. Rich with cultural traditions and vibrant illustrations that bring this sacred story to life.",
  ...
  },
  {
    ...
    description: "Enchanting stories from Sanatana Dharma that instill values of honesty, courage, and compassion in children. Each story is beautifully illustrated to capture young imaginations.",
...
// Flash Cards products (BUY DIRECTLY)
export const flashcardProducts: ProductData[] = [
  {
    id: 7,
    ...
    description: "Complete A-Z English Phonics Flash Cards set with vibrant illustrations. Designed to make early reading and phonics fun and effective for young learners aged 3 to 8.",
    language: "English",
    ageGroup: "3–8 years",
    format: "Flash Card Set (26 cards)",
  },
  {
    id: 8,
    ...
    description: "A-Z Flash Cards featuring Hindu Gods & Goddesses — learn the alphabet while discovering divine figures from Indian mythology. A unique blend of education and culture.",
    language: "English",
    ageGroup: "3–8 years",
    format: "Flash Card Set (26 cards)",
  },
  {
    ...
    description: "Telugu Varnamala Achulu Flash Cards — learn Telugu vowels (achulu) through fun, illustrated cards. Perfect for children learning Telugu as their mother tongue.",
    language: "Telugu",
    ageGroup: "3–8 years",
    format: "Flash Card Set",
  },
];

// Labels & Stickers (BUY DIRECTLY)
export const labelProducts: ProductData[] = [
  {
    id: 10,
...
// Wallpapers & Frames (ENQUIRE ONLY)
...
// Customized Story Books (ENQUIRE ONLY)
...
export const allBuyableProducts = [
  ...learningProducts,
  ...flashcardProducts,
  ...labelProducts,
];
